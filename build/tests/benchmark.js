...
let server = new tcp_1.default();
let benchmark = (packet, name) => __awaiter(void 0, void 0, void 0, function* () {
...
db_1.default.start().then(() => __awaiter(void 0, void 0, void 0, function* () {
    console.log("Connected to mysql database");
    yield benchmark(packet1, "First packet (invalid packet)");
    yield benchmark(packet2, "Second packet (invalid password)");
    yield benchmark(packet3, "Third packet (correct login)");
    db_1.default.stop();
})).catch((e) => {
